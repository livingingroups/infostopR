...
The underlying algorithm is described in [Aslak et al. (2020)](https://arxiv.org/pdf/2003.14370.pdf).
...
This package requires the Python 'infostop' package. You can install it using:
...
This package uses [Task](https://taskfile.dev/) to manage development tasks. Task is a modern alternative to Make that's easier to use and more powerful.

### Installing Task

First, install Task following the instructions at [taskfile.dev](https://taskfile.dev/installation/).

### Available Tasks

Once Task is installed, you can run the following commands from the root of the package:
