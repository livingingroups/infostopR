...
x <- spatial_infomap(data = travel_path_matrix[, c("latitude", "longitude", "time")], distance_metric = "haversine")
x$labels
...
infostop(data = travel_path_data_frame[, c("latitude", "longitude", "time")], distance_metric = "haversine")
infostop(data = travel_path_data_frame[, c("latitude", "longitude", "time")], distance_metric = "euclidean") #FIXME: wrong distance metric: can we have a warning?

find_stops(data = travel_path_data_frame[, c("latitude", "longitude", "time")], distance_metric = "haversine")
find_stops(data = travel_path_data_frame[, c("latitude", "longitude", "time")], distance_metric = "euclidean") #FIXME: wrong distance metric: can we have a warning?
