...
find_stops_xyt_h <- find_stops_xyt(x = path_matrix[, "longitude"],
...
infostop_xyt_h <- infostop_xyt(x = path_matrix[, "longitude"],
                               y = path_matrix[, "latitude"],
                               t = path_matrix[, "time"],
                               distance_metric = "haversine")
...
expect_warning(find_stops_xyt(x = path_matrix[, "longitude"],
               y = path_matrix[, "latitude"],
               t = path_matrix[, "time"],
...
expect_error(find_stops_xyt(x = path_trackframe[, "easting"],
                            y = path_trackframe[, "northing"],
                            t = path_trackframe[, "time"],
                            distance_metric = "haversine"))
expect_error(find_stops(data = path_trackframe,
                        distance_metric = "haversine"))

find_stops_tf_xyt <- find_stops_xyt(x = path_trackframe[, "easting"],
                               y = path_trackframe[, "northing"],
                               t = path_trackframe[, "time"],
                               distance_metric = "euclidean")
...
#only warning here
expect_warning(find_stops(data = path_sftrack,
                        distance_metric = "euclidean"))

find_stops_sftrack <- find_stops(data = path_sftrack,
                            distance_metric = "haversine")
...
expect_error(find_stops(data = paths_data_frame,
                      distance_metric = "haversine"))
...
expect_error(find_stops(data = paths_trackframe,
                        distance_metric = "haversine"))
