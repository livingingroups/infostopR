...
find_stops_tf <- find_stops(data = tf, distance_metric = "euclidean")
...
find_stops_tibble <- find_stops(data = tf_tibble, distance_metric = "euclidean")
...
find_stops_dt <- find_stops(data = tf_dt, distance_metric = "euclidean")
