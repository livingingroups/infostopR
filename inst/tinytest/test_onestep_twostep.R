...
expect_error(stops <- find_stops(data_m, r1 = 100, min_staying_time = 300,
...
expect_error(one_step_labels <- infostop(data_m, r1 = 100, r2 = 50, min_staying_time = 300,
                                         max_time_between = 86400, min_size = 2,
                                         distance_metric = "haversine"))
...
# xyt
data <- infostop:::example_data()
stops_xyt <- find_stops_xyt(x = data[, 1],
                            y = data[, 2],
                            t = data[, 3], r1 = 100, min_staying_time = 300,
                            max_time_between = 86400, min_size = 2,
                            distance_metric = "haversine")
...
one_step_labels_xyt <- infostop_xyt(x = data[, 1],
                                y = data[, 2],
                                t = data[, 3], r1 = 100, r2 = 50, min_staying_time = 300,
                            max_time_between = 86400, min_size = 2,
                            distance_metric = "haversine")
...
# onestep
onestep_labels <- infostop(data = path_data_frame,
                           r1 = 100, r2 = 50, min_staying_time = 300,
                           max_time_between = 86400, min_size = 2,
                           distance_metric = "euclidean")
# twostep
expect_warning(find_stops(data = path_data_frame,
                          r1 = 100, min_staying_time = 300,
                          max_time_between = 86400, min_size = 2,
                          distance_metric = "euclidean"))
stops <- find_stops(data = path_data_frame,
                    r1 = 100, min_staying_time = 300,
                    max_time_between = 86400, min_size = 2,
                    distance_metric = "euclidean")
...
# onestep
onestep_labels <- infostop(data = path_trackframe,
                           r1 = 100, r2 = 50, min_staying_time = 300,
                           max_time_between = 86400, min_size = 2,
                           distance_metric = "euclidean")


stops <- suppressWarnings(find_stops(data = path_trackframe,
                    r1 = 100, min_staying_time = 300,
                    max_time_between = 86400, min_size = 2,
                    distance_metric = "euclidean"))
clusters <- spatial_infomap(data = stops$stop_events, r2 = 50, distance_metric = "euclidean")
